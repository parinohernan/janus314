...
-- Tabla resumen de arqueo
CREATE TABLE IF NOT EXISTS caja_arqueo_resumen (
    Codigo INT AUTO_INCREMENT PRIMARY KEY,
    CajaCabezaId INT NOT NULL UNIQUE,
    TotalContado DECIMAL(15,2) NOT NULL DEFAULT 0,
    TotalSistema DECIMAL(15,2) NOT NULL DEFAULT 0,
    DiferenciaTotal DECIMAL(15,2) NOT NULL DEFAULT 0,
