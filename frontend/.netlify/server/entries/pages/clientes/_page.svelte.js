...
function _page($$payload, $$props) {
  ...
  $$payload.out += `<div class="container mx-auto p-4"><div class="flex justify-between items-center mb-4"><h1 class="text-2xl font-bold">Clientes</h1> `;
  Button($$payload, {
    variant: "primary",
    children: ($$payload2) => {
  ...
  if (loading) {
    ...
    $$payload.out += `<!--]--></button></th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">CUIT</th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"><button class="flex items-center">Deuda `;
    {
      $$payload.out += "<!--[!-->";
    }
