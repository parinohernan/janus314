...
function _page($$payload, $$props) {
  ...
  head($$payload, ($$payload2) => {
    $$payload2.title = `<title>Notas de crédito - Proveedores</title>`;
  });
  $$payload.out += `<div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8"><h1 class="text-2xl font-semibold text-gray-900 mb-6">Notas de crédito (proveedores)</h1> <div class="rounded-lg border bg-white p-4 shadow-sm mb-6"><div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4"><div><label class="block text-sm font-medium text-gray-700">Proveedor</label> <select class="mt-1 block w-full rounded-md border py-2 pl-3 pr-10 text-sm"><option value="">Todos</option><!--[-->`;
