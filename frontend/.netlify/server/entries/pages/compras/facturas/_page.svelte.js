...
function _page($$payload, $$props) {
  ...
  head($$payload, ($$payload2) => {
    $$payload2.title = `<title>Facturas de compra</title>`;
  });
  $$payload.out += `<div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8"><div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between"><h1 class="text-2xl font-semibold text-gray-900">Facturas de compra</h1> `;
  Button($$payload, {
    variant: "primary",
    children: ($$payload2) => {
      $$payload2.out += `<!---->Registrar factura`;
    },
    $$slots: { default: true }
  });
  ...
  {
    $$payload.out += "<!--[-->";
    $$payload.out += `<p class="mt-6 text-gray-500">Cargando facturas...</p>`;
  }
  $$payload.out += `<!--]--></div>`;
  pop();
}
