...
function _page($$payload, $$props) {
  ...
  $$payload.out += `<div class="container mx-auto px-4 py-6"><div class="flex justify-between items-center mb-6"><h1 class="text-2xl font-bold text-gray-800">Vista previa de nota de débito ${escape_html(tipo)}-${escape_html(sucursal)}-${escape_html(numero)}</h1> `;
  Button($$payload, {
    variant: "secondary",
    children: ($$payload2) => {
