	...
	<div class="max-w-md w-full space-y-8">
		...
		<form class="mt-8 space-y-6" on:submit|preventDefault={handleSubmit}>
			...
			<div class="rounded-md shadow-sm -space-y-px">
				{#if authConfig.mode === 'online' && modoEmpresa}
					<div>
						<p>Empresa</p>
				...
				<div>
					...
					<input
						...
						bind:value={usuario}
						class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 {authConfig.mode === 'online' && modoEmpresa ? '' : 'rounded-t-md'} focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm"
						placeholder="Usuario"
					>
				</div>
				<div class="relative">
